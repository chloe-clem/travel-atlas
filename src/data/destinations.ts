...
export const destinations: Destination[] = [
  {name:'Leiden',slug:'leiden',country:'Netherlands',continent:'Europe',latitude:52.1601,longitude:4.4970,note:'A quaint, walkable student city that felt like a calmer Amsterdam.',status:'documented',feelings:['peaceful','connected','home','inspired'],featuredImage:'photos/leiden/img_0541.jpg',visitLabel:'Study abroad',story:[
  ...
  {name:'The Hague',slug:'the-hague',country:'Netherlands',continent:'Europe',latitude:52.0705,longitude:4.3007,note:'A modern city balanced by beaches, parks, and forest.',status:'documented',feelings:['peaceful','energized','inspired'],featuredImage:'',visitLabel:'Study abroad',story:[
  ...
  {name:'Amsterdam',slug:'amsterdam',country:'Netherlands',continent:'Europe',latitude:52.3676,longitude:4.9041,note:'A busy but charming city full of museums, food, canals, and easy movement.',status:'documented',feelings:['energized','inspired','connected'],featuredImage:'',visitLabel:'Study abroad',story:[
  ...
  {name:'Haarlem',slug:'haarlem',country:'Netherlands',continent:'Europe',latitude:52.3874,longitude:4.6462,note:'A surprisingly quiet and relaxing city near Amsterdam.',status:'documented',feelings:['peaceful','inspired'],featuredImage:'',visitLabel:'Study abroad',story:[
  ...
  {name:'Saint-Tropez',slug:'saint-tropez',country:'France',continent:'Europe',latitude:43.2677,longitude:6.6407,note:'A lively but relaxing coastal town of yachts, beaches, and sunset swims.',status:'documented',feelings:['peaceful','energized','connected'],featuredImage:'',visitLabel:'Study abroad',story:[
  ...
  {name:'Paris',slug:'paris',country:'France',continent:'Europe',latitude:48.8566,longitude:2.3522,note:'Nighttime magic, huge museums, underground history, and unforgettable food finds.',status:'documented',feelings:['energized','inspired','connected'],featuredImage:'',visitLabel:'Study abroad',story:[
  ...
  {name:'Cologne',slug:'cologne',country:'Germany',continent:'Europe',latitude:50.9375,longitude:6.9603,note:'A monumental cathedral, chocolate, river walks, and a more distant city mood.',status:'documented',feelings:['inspired','peaceful'],featuredImage:'',visitLabel:'Short visit',story:[
  ...
  {name:'Munich',slug:'munich',country:'Germany',continent:'Europe',latitude:48.1351,longitude:11.5820,note:'Parks, winter canals, river surfers, and a thrilling New Year’s Eve.',status:'documented',feelings:['energized','connected','inspired'],featuredImage:'',visitLabel:'New Year’s visit',story:[
  ...
  {name:'Berchtesgaden',slug:'berchtesgaden',country:'Germany',continent:'Europe',latitude:47.6302,longitude:13.0001,note:'Dreamlike national-park hikes and some of the most beautiful views of the trip.',status:'documented',feelings:['wild','peaceful','inspired'],featuredImage:'',visitLabel:'Study abroad',story:[
  ...
  {name:'La Hulpe',slug:'la-hulpe',country:'Belgium',continent:'Europe',latitude:50.7309,longitude:4.4857,note:'A welcoming hidden gem of forest trails, ponds, horses, and château grounds.',status:'documented',feelings:['peaceful','connected','wild'],featuredImage:'',visitLabel:'Study abroad',story:[
  ...
  {name:'Bern',slug:'bern',country:'Switzerland',continent:'Europe',latitude:46.9480,longitude:7.4474,note:'An accessible green city of hills and meadows before the Alps.',status:'documented',feelings:['peaceful','inspired'],featuredImage:'',visitLabel:'Study abroad',story:[
  ...
  {name:'Brig',slug:'brig',country:'Switzerland',continent:'Europe',latitude:46.3167,longitude:7.9833,note:'A quiet Alpine town discovered by taking the wrong train.',status:'documented',feelings:['peaceful','home'],featuredImage:'',visitLabel:'Study abroad',story:[
    'I ended up in Brig by accident after taking the wrong train, but I was so glad I did.',
    'It was such a cute, quiet town.'
  ]},
  {name:'Kandersteg',slug:'kandersteg',country:'Switzerland',continent:'Europe',latitude:46.4947,longitude:7.6733,note:'Snow, green meadows, mountains, and a favorite canoeing memory.',status:'documented',feelings:['wild','peaceful','inspired'],featuredImage:'',visitLabel:'September trip',story:[
  ...
  {name:'Sorrento',slug:'sorrento',country:'Italy',continent:'Europe',latitude:40.6263,longitude:14.3758,note:'A clean, safe coastal base with lively evening walks and easy access to Pompeii.',status:'documented',feelings:['peaceful','connected','energized'],featuredImage:'',visitLabel:'Pompeii trip',story:[
  ...
  {name:'Salzburg',slug:'salzburg',country:'Austria',continent:'Europe',latitude:47.8095,longitude:13.0550,note:'A pretty, compact city with Christmas markets and easy access to nearby hikes.',status:'documented',feelings:['inspired','connected','peaceful'],featuredImage:'',visitLabel:'Friend visit',story:[
