...
export const destinations: Destination[] = [
  {name:'Leiden',slug:'leiden',country:'Netherlands',continent:'Europe',latitude:52.1601,longitude:4.4970,note:'A quaint, walkable student city that felt like a calmer Amsterdam.',status:'documented',feelings:['immersed','relaxed','home','inspired'],featuredImage:'photos/leiden/img_0541.jpg',visitLabel:'Study abroad',story:[
